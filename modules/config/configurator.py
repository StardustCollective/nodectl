...
class Configurator():
    ...
    def manual_setup_alerting(self,profile="Global"):
        ...
        description3 += "each email by a comma. eg) 'email1@gmail.com,email2@yahoo.com'."
        description4 = "In order to make your alerts more read friendly, nodectl will convert the default UTC time utilized by the node "
