...
class Versioning():
    ...
    def __init__(self,command_obj):
        ...
        nodectl_version = "v2.11.0"
        nodectl_yaml_version = "v2.0.0"
    ...
    def pull_upgrade_path(self):
        ...
        if do_update or self.force:
            try:
                upgrade_path = get(self.upgrade_path_path,headers=self.functions.get_headers)
            except:
    ...
    def is_nodectl_pre_release(self):
        ...
        try:
            pre_release = get(pre_release_uri,headers=self.functions.get_headers).json()
    ...
    def verify_version_object(self):
        ...
        if self.verify_only:
            ...
            self.functions.print_paragraphs([
                [" VERSION OBJECT ",0,"green,on_yellow"],
